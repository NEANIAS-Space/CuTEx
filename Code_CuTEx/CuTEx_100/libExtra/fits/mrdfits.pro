...
;                 insufficient  
;       V2.12b Fix for variable length arrays with virtual machine
;                  R. Preece   June 2007
;                  
;-
...
function mrdfits, file, extension, header,      $
    ...
    if keyword_set(version) then begin
        print,'MRDFITS: Version '+mrd_version()+' June 22, 2007'
    endif
    ...
    inputUnit = 0
    if sz[1] gt 0 and sz[1] lt 4 then begin    ;File unit number specified
