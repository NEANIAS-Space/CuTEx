...
imap=strupcase([sinstr,yinstr,smminstr,radinstr,optinstr,packinstr,spinstr,trinstr,hsinstr,csinstr,hxinstr,smeinstr,goesinstr,vobsinstr,sterinstr,solbinstr])
mmap=strupcase([replicate('soho',n_elements(sinstr)),$
                ...
                'SPARTAN','TRACE','HESSI','CGRO','HXRS','SMEI', $
                ...
                replicate('solarb',n_elements(solbinstr))  ])
...
if solarb  then instr=[instr,solbinstr]
