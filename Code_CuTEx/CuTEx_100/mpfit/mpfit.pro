...
;      CM, 29 Mar 2008
;
;  $Id: mpfit.pro,v 1.1.1.1 2013/09/17 08:36:36 higal_repository Exp $
;-
...
pro mpfit_parinfo, parinfo, tnames, tag, values, default=def, status=status, $
  ...
  if ct EQ 0 then begin
      ...
      values = parinfo.(wh[0])
; line below commented by S.Molinari because LIMITED and LIMITS should not be 1D arrays
;      values = values[*]  ;; Make sure the array is 1-D
  endelse
