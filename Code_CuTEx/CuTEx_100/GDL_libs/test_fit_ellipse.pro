...
FUNCTION test_Fit_Ellipse, indices, XSize=xsize, YSize=ysize, NPoints=npoints, $
...
; la matrice e' sempre 2x2 allora uso un metodo piu' semplice
autovalori,tensor,evals,evecs
